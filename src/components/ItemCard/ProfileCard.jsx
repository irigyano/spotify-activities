  ...
  return (
    <div id="profilecard" className=" bg-white bg-opacity-50 rounded-md w-56 md:w-80">
      <div className="flex justify-center items-center">
        <img
          alt="profile_picture"
          className="w-56 h-56 md:w-64 md:h-64 p-2 rounded-2xl object-cover"
      ...
      <div>
        ...
        <ul>
          {artistsData.slice(0, 3).map((artist, index) => {
            return (
              <li key={artist.id} className="flex items-center overflow-x-auto no-scrollbar">
                <a
                  target="_blank"
                  rel="noreferrer"
          ...
          {tracksData.slice(0, 3).map((track) => {
            return (
              <li key={track.id} className="flex items-center">
                ...
                <div className="flex flex-col justify-center h-14 overflow-x-auto no-scrollbar">
                  <a
